...
class experimentConfiguration:
    ...
    def loadConfiguration(self,myConfiguration_):
        ...
        if myConfiguration_ == 'iotjournal':
            ...
            self.func_SERVICEMESSAGESIZE = "random.randint(1500000,4500000)" #BYTES 
            self.func_SERVICERESOURCES = "random.randint(1,6)" #MB 
            self.func_APPDEADLINE="random.randint(2600,6600)" #MS
        
        
            #USERS and IoT DEVICES
            self.func_REQUESTPROB="random.random()/4" #Popularidad 
